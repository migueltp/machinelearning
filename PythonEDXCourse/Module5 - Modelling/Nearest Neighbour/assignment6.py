...
#
path = '/home/miguelserrano/Projects/Research/machinelearning/PythonEDXCourse/Module4 - Transformation/Isomap/Datasets/face_data.mat'
mat = scipy.io.loadmat('{}'.format(path))
...
# loaded it correctly
#
face_labels = pd.read_csv('Datasets/face_labels.csv', names='a')
