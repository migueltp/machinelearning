...
X_room = X['Room.Board']
X_accept = X['Accept']
data_train, data_test, label_train, label_test = train_test_split(X_room, 
                                                                  X_accept,
                                                                  test_size=0.5,
                                                                  random_state=7)
...
model.fit(data_train, label_train)
score = model.score(data_test, label_test)
drawLine(model, data_test, label_test, "Accept(Enroll)", score)
...
model.fit(data_train, label_train)
score = model.score(data_test, label_test)
drawLine(model, data_test, label_test, "Accept(F.Undergrad)", score)
...
#
X_room = X[['Room.Board', 'Enroll']]
X_accept = X['Accept']
data_train, data_test, label_train, label_test = train_test_split(X_room, 
                                                                  X_accept,
                                                                  test_size=0.5,
                                                                  random_state=7)
#data_train.reshape(-1,1)
#data_test = data_test.reshape(-1,1)
model = linear_model.LinearRegression()
model.fit(data_train, label_train)
score = model.score(data_test, label_test)
